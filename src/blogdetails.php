  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">EDIT YOUR CONTENT</h5>
    ...
    <script>
      $(document).ready(function(){
        ...
        let postid = <?php echo $_GET['post_id']; ?>;
        display_particular();
        function display_particular(){
          $.ajax({
            url:'blogdetails_server.php',
            method:'POST',
            data:{'click_user_id':userid,'click_post_id':postid},
        ...
        function display_all(){
          ...
          $.ajax({
            url:'blogdetails_server.php',
            method:'POST',
            data:{'show_all_post_user':userid},
            success:function(result){
             // alert(result);
              $("#display").html(result);
            }
