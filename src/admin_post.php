  ...
  <div class="row">
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-3 bg-info" style="width: 280px;">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        ...
        <span class="fs-4">Admnin Post</span>
      </a>
      <hr>
      ...
      <div class="pt-4 px-4 bg-info">
          <div class="bg-light text-center rounded p-4">
              ...
              <div class="table-responsive">
                  <table class="table text-start align-middle table-bordered table-hover mb-0 display__post_table">
  ...
  <script>
    $(document).ready(function(){
        ...
        function display_post(){
            $.ajax({
                url:'admin_post_server.php',
                method:'POST',
                data:{'post_data':1},
                success:function(result){
                    console.log(result);
                    $('.display__post_table').html(result);
                }
            });
        }

        $('.display__post_table').on("change",".change_post_status",function(){
            //alert($(this).attr('id'));
            ...
            $.ajax({
              url:'admin_post_server.php',
              method:'POST',
              data:{'post_id':postid,'status_value':value},
              success:function(result){
                console.log(result);
                display_post();
              }
